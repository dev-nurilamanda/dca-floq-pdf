function generatePDFDCAFloq() {
  ...
  for (var i = 1; i < data.length; i++) {
    ...
    var rawDate = data[i][0] instanceof Date ? data[i][0] : new Date(data[i][0]);
  ...
  // Periode Otomatis dari Data Transaksi
  var periodeText = "Belum Ada Transaksi";
  if (minDate && maxDate) {
    var strMin = Utilities.formatDate(minDate, "GMT+7", "MMM yyyy");
    var strMax = Utilities.formatDate(maxDate, "GMT+7", "MMM yyyy");
    periodeText = (strMin === strMax) ? strMin : strMin + " – " + strMax;
  }
  ...
  <head>
    <style>
      ...
      .floq-brand-wrap { display: flex; align-items: center; gap: 8px; margin-bottom: 5px; }
      .floq-text { font-size: 26pt; font-weight: 800; color: #000; letter-spacing: 1px; line-height: 1; }
      ...
      <table class="header-table">
        <tr>
          <td class="brand-section">
            <div class="floq-brand-wrap">
              <!-- Inline SVG Logo Floq Hitam Transparan -->
              <svg width="36" height="36" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 10 H90 V25 H25 V45 H80 V60 H25 V90 H10 Z" fill="#000000"/>
              </svg>
              <span class="floq-text">FLOQ</span>
            </div>
          ...
          <td class="owner-section">
            <div class="owner-card-inner">
              ...
              <table class="info-grid">
                ...
                <tr><td class="lbl">Periode</td><td class="cln">:</td><td class="val">${periodeText}</td></tr>
              </table>
            </div>
          </td>
        </tr>
